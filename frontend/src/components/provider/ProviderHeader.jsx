      ...
      <div className="flex flex-col md:flex-row gap-6 md:items-center">
        ...
        <div className="flex-1 text-center md:text-left">
          ...
          <div className="flex flex-wrap justify-center md:justify-start gap-4 text-sm mb-3">
            <div className="flex items-center gap-1"><Star className="fill-yellow-400 text-yellow-400 w-4" />{provider.averageRating} <span className="text-slate-600">({provider.totalReviews})</span></div>
